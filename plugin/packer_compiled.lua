...
_G.packer_plugins = {
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["gv.vim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/gv.vim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/typescript.nvim",
